...
### \<head> Element
The head element contains the metadata and title of my webpage. By creating the head element, I learned how to set the character set, viewport properties such as width and inital zoom, and creating link elements to import fonts and stylesheets, and setting the title of my webpage.
...
### Media Query
By using @media screen and setting proportions, I learned how to make websites that are mobile conscious. By designing for mobile sites first and then  using a media query, we can ensure that the websites we create are scalable and look good on any device.
